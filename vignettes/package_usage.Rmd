...
Note When importing your own data, `ctmm::as.telemetry` will return single telemetry object with single animal, and a list of telemetry objects with multiple animals. To make code consistent we always work with a list of telemetry objects. You can use ctmmweb::as_tele_list to make sure it's a proper list.
...
# for importing data, use ctmmweb::as_tele_list to make sure it's a proper list.
# data <- as_tele_list(as_telemetry(data_file))
