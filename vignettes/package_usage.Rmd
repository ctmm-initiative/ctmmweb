...
Plot the location, sampling time with these functions to reproduce the plots in `Visualization` page. Note some functions need both the selected subset and the full data set, because we need to know all animals to maintain a consistent color mapping to animals in various selections..
