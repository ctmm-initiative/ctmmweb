...
loc_data_distance <- calc_distance(loc_data)
...
loc_data_speed <- calc_speed(loc_data_distance)
...
# try multiple models in parallel with ctmm.select
...
![](screenshot/05_model_res_structure.png){ width=50% }
