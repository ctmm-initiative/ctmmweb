...
1. Install R
    ...
    Download [R installer](https://cloud.r-project.org/bin/windows/base/old/3.5.2/R-3.5.2-win.exe) and install R.

    *[RStudio](https://download1.rstudio.org/RStudio-1.1.463.exe) is recommended but not a must.*
