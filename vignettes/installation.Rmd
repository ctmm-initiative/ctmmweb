...
- There is a known problem with `DT` that model summary table in `model selection` page doesn't repond to row selection when only one animal is available. Clicking `Clear Table` can fix the problem.
