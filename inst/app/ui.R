...
range_plot_box <- box(title = "Home Range Estimation",
   ...
   fluidRow(
     ...
     #                                     "Hide Contours",
     #                                     value = FALSE)),
     column(4, checkboxGroupInput("hrange_control", label = NULL,
...
overlap_plot_box <- tabBox(title = "Plot", id = "overlap_tabs", width = 12,
          ...
          tabPanel("Home Range",
           fluidRow(
             ...
             #                                          "Confidence envelopes",
             #                                          "Location points"))),
             column(4, checkboxGroupInput("overlap_hrange_control", label = NULL,
                          choiceNames = list(div(icon("circle-o"),
                                                 HTML('&nbsp;'),
                                                 "Home Range Contours"),
                                             div(icon("bullseye"),
...
occurrence_plot_box <- box(title = "Occurrence Distribution",
                      ...
                      solidHeader = TRUE, width = 12,
                  fluidRow(
                    column(4, checkboxGroupInput("occur_control", label = NULL,
                           choiceNames = list(div(icon("circle-o"),
                                                  HTML('&nbsp;'),
                                                  "Home Range Contours"),
                                              div(icon("bullseye"),
