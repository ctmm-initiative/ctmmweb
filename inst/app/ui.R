   ...
   fluidRow(
     column(6, offset = 0,
            textInput("hr_level_text",
                      ...
                      value = "95")),
     column(3, offset = 0, br(), checkboxInput("hrange_contours",
                                         "Show Contours",
                                         value = TRUE)),
...
overlap_plot_box <- tabBox(title = "Plot", id = "overlap_tabs", width = 12,
          ...
          tabPanel("Home Range",
           fluidRow(
             column(6, offset = 0, textInput("overlap_hrange_level_text",
                                             "Home Range Contours in %",
                                             value = "95")),
             column(3, offset = 1, numericInput("overlap_hrange_height",
                                                "Canvas height",
                                                value = 600,
                                                min = 200, max = 1200,
                                                step = 100)),
             column(2, offset = 0, numericInput("overlap_hrange_columns",
                                                ...
                                                value = 2, min = 1, max = 6,
                                                step = 1)),
             column(3, offset = 0, checkboxInput("overlap_contours",
                                                 "Show Contours",
                                                 value = TRUE)),
             column(3, offset = 0,
                    checkboxInput("overlap_hrange_intervals",
                  ...
                  fluidRow(
                    column(6, offset = 0,
                           textInput("oc_level_text",
                                     ...
                                     value = "95")),
                    column(3, offset = 0, br(), checkboxInput("oc_contours",
                                                              "Show Contours",
                                                              value = TRUE)),
