                            ...
                            tabPanel("1. Overview",
                                 ...
                                 fluidRow(column(8, offset = 4,
                                  checkboxInput("overlay_all",
                                                h4("All inidividuals in background"),
                                                value = TRUE))),
...
# p3. outlier ----
outlier_his_box <- tabBox(title = "Outlier Detection",
                       id = "outlier_his_tabs", width = 12,
                       tabPanel("Distance to center",
                                fluidRow(column(4,sliderInput("distance_his_bins", "Histogram Bins",
                                                              min = 20, max = 50, value = 40, step = 1)),
                                         column(4, sliderInput("distance_his_y_limit",
                                                               "Limit y axis",
                                                               min = 10, max = 50, value = 20, step = 1)),
                                         column(4, sliderInput("distance_color_bins",
...
histogram_subsetting_box <- box(title = "Select Time Range",
                                ...
                                fluidRow(column(6, offset = 2,
                                                sliderInput("time_color_bins", "Color Bins",
...
selected_plot_box <- box(title = "Locations in Selected Time Range",
                         ...
                         fluidRow(column(5, offset = 4,
                                 sliderInput("point_size_time_loc", "Size of points in plot",
                                             min = 0.05, max = 1, value = 0.1, step = 0.05,
                                             width = "100%"))),
