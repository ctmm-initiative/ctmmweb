...
outlier_his_box <- tabBox(title = "Outlier Detection",
  ...
  tabPanel("Distance to center",
    fluidRow(column(4, offset = 1, sliderInput("distance_his_bins", "Histogram Bins",
                                  min = 10, max = 50, value = 40, step = 1)),
             column(4, offset = 2, sliderInput("distance_his_y_limit",
                                   "Limit y axis",
  ...
  tabPanel("Speed",
    fluidRow(column(4, offset = 1, sliderInput("speed_his_bins", "Histogram Bins",
                             min = 10, max = 50, value = 40, step = 1)),
        column(4, offset = 2, sliderInput("speed_his_y_limit",
                              "Limit y axis",
                              min = 10, max = 50, value = 20, step = 1))
    ),
